...
public class GPDispatcherServlet extends HttpServlet {
    ...
    protected void initStrategies(GPApplicationContext context) {
        ...
        // 每种策略可以自定义干预，但是最终的结果都是一致ModelAndView
        ...
        try {
            for (String beanName : beanNames) {
                ...
                for (Method method : methods) {
                    ...
                    log.info("pattern:" + pattern + ", method:" + method);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void initHandlerAdapters(GPApplicationContext context) {
        ...
        for (GPHandlerMapping handlerMapping : this.handlerMappings) {
            ...
            //接下来，我们处理非命名参数,只处理Request和Response
    ...
    /**
     * http://localhost:8080/web/addTeacher.json?name=Tom&addr=hunan
     *
     * @param req
     * @param resp
     * @throws Exception
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        GPHandlerMapping handlerMapping = getHandlerMapping(req);
        // 如果没有方法处理请求，报404
    ...
    private GPHandlerAdapter getHandlerAdapter(GPHandlerMapping handler) {
        ...
        return ha.supports(handler) ? this.handlerAdapters.get(handler) : null;
    }
